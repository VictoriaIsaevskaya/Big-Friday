export const preferenceFields = [
  ...
  { controlName: 'preferredLanguages', placeholder: 'Preferred Languages', type: 'select', icon: 'language-outline', options: ['English', 'Russian', 'Polish', 'Spanish', 'French'], multiple: true, isEditing: false },
