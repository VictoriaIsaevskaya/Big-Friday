...
export const preferenceFields: PreferenceField[] = [
  ...
  { controlName: 'photo', placeholder: 'Upload a Photo', type: 'file', icon: 'camera-outline', isEditing: false, isOverflowing: false},
  { controlName: 'about', placeholder: 'About Me', type: 'textarea', icon: 'information-circle-outline', isEditing: false, isOverflowing: false },
